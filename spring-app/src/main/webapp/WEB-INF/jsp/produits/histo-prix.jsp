...
<%
    ...
    List<PrixProduit> prixProduits = (List<PrixProduit>) request.getAttribute("prix");
...
<head>
    ...
    <title>Boulangerie - Historique</title>
        ...
        <div class="container py-4">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <h3 class="text-center mb-4">Historique des prix</h3>

                    <!-- Formulaire de filtres -->
                    <form method="get" action="${pageContext.request.contextPath}/produits/historiques/prix" class="mb-4">
                        <div class="row g-3">
                            <!-- Sélecteur de produit -->
                            <div class="col-md-4">
                                <label for="idProduit" class="form-label">Nom du produit</label>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" class="text-center">Aucun changement de prix trouvé</td>
                                </tr>
                                <% } else {
                                ...
                                <tr>
                                    ...
                                    <td><%= prixProduit.getDateModif() %></td>
