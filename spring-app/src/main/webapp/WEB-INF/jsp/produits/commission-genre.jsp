            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-center mb-4">Liste des commissions par genre</h3>
                        <!-- Liste des clients -->
                        <a href="/produits/commissions" class="btn btn-primary">Commissions</a>
                    </div>

                    <!-- Formulaire de filtres -->
                    <form method="get" action="${pageContext.request.contextPath}/produits/commissions/genres" class="mb-4">
                        <div class="row g-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" style="font-size: 0.875rem;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center">Aucune commission trouvée pour les 2 genres!</td>
                                </tr> <% 
                                } else {
                                    for (Map<String, Object> commission : commissions) { %>
                                    <tr>
                                        <td><%= commission.get("id_genre") %></td>
                                        <td><%= commission.get("nom_genre") %></td>
                                        <td><%= commission.get("commission_totale") %></td>
                                    </tr>
                                <% } } %>
                            </tbody>
                        </table>
